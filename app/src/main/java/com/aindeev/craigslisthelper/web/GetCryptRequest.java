 ...
 */
public class GetCryptRequest extends AuthRequest<String> {
    ...
    private Post post;
    Post.ManageActionType actionType;

    public GetCryptRequest(Activity activity, Post post, Post.ManageActionType actionType) {
    ...
    public String getResult() {
        return post.getCryptByAction(actionType);
    }
